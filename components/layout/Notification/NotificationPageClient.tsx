          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-[40px] md:mb-[50px]">
            ...
            <div className="md:ml-4 md:w-auto">
              <button
                ...
                className="inline-flex text-base justify-center items-center gap-2 bg-white text-[#2275B9] px-4 py-2 rounded-xl shadow-xl cursor-pointer hover:shadow-lg transition border"
              >
                Mark all as read
              </button>
            </div>
