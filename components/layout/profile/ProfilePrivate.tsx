    ...
    <div className="mt-24 md:mt-12 px-4 sm:px-10 md:px-14 lg:px-20 mb-14 max-w-5xl mx-auto">
      <div className="relative w-full h-[180px] md:h-[250px] mt-2 md:-mt-2">
        ...
        <Image
          ...
          width={120}
          height={120}
          className="absolute z-20 left-2 w-[90px] h-[90px] -bottom-12 md:w-[120px] md:h-[120px] md:-bottom-14  md:left-5 "
        />
      ...
      <div className="mt-18">
        ...
        <p className="mt-4 text-sm sm:text-base">
          Billionaire philantropist. Lorem ipsum dolor sit amet consectetur
          adipisicing elit. Aperiam repudiandae sapiente aliquam autem obcaecati
          officiis, nesciunt unde illum. Veniam, doloremque autem iure quae
          nobis, repellendus iste facilis consequatur sit temporibus voluptas
          quas cumque porro voluptatem! Vero?
        </p>
