    ...
    <div className="w-full px-6">
      ...
      {List.map((list) => (
        <Link 
          ...
          className="block"
        >
          <div className="grid grid-cols-[480px_270px_200px_230px_100px] items-center cursor-pointer hover:bg-gray-50 p-2 rounded-lg border-b border-[#CDCDCD]/50 min-w-[1270px]">
